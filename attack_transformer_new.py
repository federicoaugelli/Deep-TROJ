...
from attack_utils_transformer import *
...
from losses_transformer import TrojanAttackLoss
...
def rank_blocks(model, train_loader):
    ...
    w = flatten_weight_f_extractor(model)
    
    if args.dataset == 'cifar10' or args.dataset == 'cifar100':
        trigger = torch.zeros(1,3,32,32).cuda()
        trigger[:,:, 16:28, 16:28] = 1.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rounds', type=int, default=5, help='attack rounds')
